# Auto-generated DAG for Workflow: ml_training_from_git
# Workflow ID: 970f626b-0f3e-4b69-9e56-c267950dad01
...
GIT_REPOSITORY = 'https://github.com/example/ml-training.git'
GIT_BRANCH = 'main'
...
# Create DAG
with DAG(
    dag_id='workflow_970f626b-0f3e-4b69-9e56-c267950dad01',
    default_args=default_args,
    description='ML Training Pipeline using Git Repository',
    schedule_interval='@daily',
    start_date=datetime(2024, 1, 1),
    catchup=False,
    tags=['mlops', 'auto-generated', 'ml_training_from_git']
) as dag:
    ...
    def load_data_func(**context):
        """
        Git-based task function for: load_data
        Repository: https://github.com/example/ml-training.git
        ...
        return execute_git_task(
            ...
            branch=GIT_BRANCH,
            script_path='src/data/load.py',
            function_name='load_training_data',
            **context
        )
    ...
    train_model = PythonOperator(
        ...
        op_kwargs={'max_depth': 10, 'n_estimators': 100},
        retries=2,
